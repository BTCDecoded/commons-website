...
- **Governance dimensions (forkable)**: Action tiers, nested multisig teams, governance review policy, repository layers, tier classification, emergency procedures, cross-layer rules, commons contributor thresholds, validation requirements
